            ...
            while running:
                ...
                try:
                    ...
                    if func:
                        ...
                        print(str(move_2 + float(toponym_longitude)), str(move_3 + float(toponym_lattitude)))'''
                        ...
                        if not response:
                            ...
                            pass
                        if func_6:
                            toponym_to_find = f'{str(move_2 + float(toponym_longitude))}, {str(move_3 + float(toponym_lattitude))}'
                            func_6 = False
